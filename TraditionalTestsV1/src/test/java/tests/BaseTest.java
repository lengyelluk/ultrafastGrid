...
public class BaseTest {
    ...
    protected void createDriver(BrowserType browser, String browserVersion, DeviceType device, String testName, RunType runType) {
        ...
        switch(runType) {
            ...
            case BROWSERSTACK:
                ...
                capabilities.setCapability("build", "Traditional Tests V1");
    ...
    public void copyResultsToRootFolder() {
        File source = new File("Traditional-V1-TestResults.txt");
        File dest = new File("../Traditional-V1-TestResults.txt");
        try {
